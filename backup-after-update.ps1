...
# GitHub Backup (after update)
$backup1 = Join-Path $backupDir1 "backup_after_$timestamp"
Write-Host "Creating GitHub backup after update..."
...
# CPanel Backup (after update) - ready for deployment
$backup2 = Join-Path $backupDir2 "backup_after_$timestamp"
Write-Host "Creating CPanel backup after update..."
